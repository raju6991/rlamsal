        ...
        content: fields.document({
          ...
          componentBlocks: {
            ...
            playground: component({
              ...
              preview: () => (
                <div style={{ padding: '1rem', background: '#ccc', borderRadius: '4px' }}>
                  Playground Preview
                </div>
              ),
              schema: {
            ...
            sandbox: component({
              ...
              schema: {
                initialCode: fields.text({ label: 'Initial Code', multiline: true }),
                language: fields.text({ label: 'Language', defaultValue: 'css' }),
              },
            }),
            illustration: component({
              label: 'Interactive Illustration',
              preview: () => (
                <div style={{ padding: '1rem', background: '#e0e0e0', borderRadius: '4px' }}>
                  Playground + Sandbox
                </div>
              ),
              schema: {
